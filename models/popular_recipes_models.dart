...
//
//     final popularRecipes = popularRecipesFromJson(jsonString);

import 'dart:convert';

PopularRecipes popularRecipesFromJson(String str) =>
    PopularRecipes.fromJson(json.decode(str));

String popularRecipesToJson(PopularRecipes data) => json.encode(data.toJson());
...
class PopularRecipes {
  ...
  factory PopularRecipes.fromJson(Map<String, dynamic> json) => PopularRecipes(
        recipes:
